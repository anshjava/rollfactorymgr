...
public class RollEditViewModel implements ViewModel, DisposableByEvent {
    ...
    @Getter
    private ObjectProperty<BigDecimal> valueProperty = new SimpleObjectProperty<>();
    ...
    public BigDecimal calculateWeight(Roll rollToCalculate) {
        return rollToCalculate.calculateWeight();
    }

    public BigDecimal calculateLength(Roll rollToCalculate) {
        return rollToCalculate.calculateLength();
    }
    public BigDecimal calculateDiameter(Roll rollToCalculate) {
        return rollToCalculate.calculateDiameter();
    }
}